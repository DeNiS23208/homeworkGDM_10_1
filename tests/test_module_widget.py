...
def test_mask_account_card_various_types(input_string, expected):
...
def test_invalid_card_and_account(num_invalid_number_card):
...
def test_get_data_invalid_format(input_date):
